...
const optionsDefaults = {
  ...
  gravity: 'Center',
  format: null,
  quality: 75,  // Note for PNG this control compression only as lossless
  blur: null,
  rotate: null,
  flip: false,
  alpha: null,
  ...
  proceed () {
    return new Promise((resolve, reject) => {
      ...
      function failed(data) {
        // Note this can fire twice - don't think its a problem
